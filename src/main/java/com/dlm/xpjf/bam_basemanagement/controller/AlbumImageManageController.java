...
public class AlbumImageManageController {
	
	@Autowired
	AlbumImageService service;
	/**
	 * 	查询所有
	 * @return
	 */
	...
	public @ResponseBody ResponseEntity findAll(){
		...
		List<AlbumImage> list = service.list();
		data.put("list", list);
	...
	public @ResponseBody ResponseEntity findById(@RequestBody RequestEntity requestEntity){
		...
		AlbumImage record = service.get(requestEntity.getId());
	...
	public @ResponseBody ResponseEntity add(@RequestBody RequestEntity requestEntity){
		ResponseEntity responseEntity = new ResponseEntity();
		try {
			service.add(requestEntity.getAlbumImage());
			Map<String, Object> data = new HashMap<String, Object>();
			
			data.put("record", requestEntity.getAlbumImage());
			responseEntity.setData(data);
		} catch (Exception e) {
	 ...
	 * @return
	 */
	@RequestMapping("addAlbumImageList")
	public @ResponseBody ResponseEntity addAlbumImageList(@RequestBody RequestEntity requestEntity){
		ResponseEntity responseEntity = new ResponseEntity();
		try {
			service.addAlbumImageList(requestEntity.getAlbumId(),requestEntity.getImgUrlList());
			Map<String, Object> data = new HashMap<String, Object>();
//			data.put("record", requestEntity.getAlbumImage());
			responseEntity.setData(data);
		} catch (Exception e) {
	...
	public @ResponseBody ResponseEntity update(@RequestBody RequestEntity requestEntity){
		ResponseEntity responseEntity = new ResponseEntity();
		try {
			service.update(requestEntity.getAlbumImage());
		} catch (Exception e) {
			responseEntity.setSuccess(CommonConstant.RESPONSE_FAIL);
			responseEntity.setErrorMsg(e.getMessage());
		}
...
//	 * @return
//	 */
//	@RequestMapping("findHouseholdAlbumListByHouseholdId")
//	public @ResponseBody ResponseEntity findHouseholdAlbumListByHouseholdId(@RequestBody RequestEntity requestEntity){
//		ResponseEntity responseEntity = new ResponseEntity();
//		Map<String, Object> data = new HashMap<String, Object>();
//		
//		List<HouseholdAlbum> list = service.findHouseholdAlbumListByHouseholdId(requestEntity.getId());
//		data.put("list", list);
//		responseEntity.setData(data);
//		return responseEntity;
//	}
